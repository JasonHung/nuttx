...
#define RT5647_IN1_IN2                  0x0d
#define RT5647_IN3                      0x0e
#define RT5647_INL1_INR1_VOL            0x0f
#define RT5647_SPK_FUNC_LIM             0x14
#define RT5647_ADJ_HPF_CTRL             0x16
/* I/O - ADC/DAC/DMIC */
...
#define RT5647_DD_MIXER                 0x2b
#define RT5647_DIG_MIXER                0x2c
#define RT5647_DSP_PATH1                0x2d
#define RT5647_DSP_PATH2                0x2e
...
#define RT5647_MONO_MIXER               0x4c
#define RT5647_OUT_L1_MIXER             0x4f
#define RT5647_OUT_R1_MIXER             0x52
...
#define RT5647_TDM_CTRL_4               0x7a

/* Function - Analog */
#define RT5647_DSP_CLK                  0x7f
...
#define RT5647_ASRC_4                   0x86
#define RT5647_ASRC_5                   0x87
#define RT5647_ASRC_7                   0x89
#define RT5647_ASRC_8                   0x8a
#define RT5647_ASRC_9                   0x8b
#define RT5647_ASRC_10                  0x8c
#define RT5647_ASRC_11                  0x8d
...
#define RT5647_A_JD_CTRL2               0x95
#define RT5647_ASRC_12                  0x97
#define RT5647_ASRC_13                  0x98
#define RT5647_ASRC_14                  0x99
...
#define RT5647_DMIC_2_DP_MASK           (0x1 << 10)
#define RT5647_DMIC_2_DP_SFT            10
#define RT5647_DMIC_2_DP_GPIO4          (0x0 << 10)
#define RT5647_DMIC_2_DP_IN1N           (0x1 << 10)
...
#define RT5647_DMIC_1_DP_GPIO6          (0x0 << 0)
#define RT5647_DMIC_1_DP_IN2P           (0x1 << 0)
#define RT5647_DMIC_1_DP_GPIO7          (0x2 << 0)
...
#define RT5647_CLSD_OM_MASK         (0x1 << 11)
#define RT5647_CLSD_OM_SFT          11
#define RT5647_CLSD_OM_MONO         (0x0 << 11)
#define RT5647_CLSD_OM_STO          (0x1 << 11)
#define RT5647_CLSD_SCH_MASK            (0x1 << 10)
#define RT5647_CLSD_SCH_SFT         10
#define RT5647_CLSD_SCH_L           (0x0 << 10)
#define RT5647_CLSD_SCH_S           (0x1 << 10)
...
#define GB_AUDIO_ACCESS_ALL (GB_AUDIO_ACCESS_READ | GB_AUDIO_ACCESS_WRITE)
#define GB_AUDIO_STREAM_TYPE_BI (GB_AUDIO_STREAM_TYPE_CAPTURE | \
                                GB_AUDIO_STREAM_TYPE_PLAYBACK)

#define CONTROL(xname, xid, xiface, xaccess, xcport, xstream) \
    {   .name = xname, .id = xid, .iface = GB_AUDIO_IFACE_##xiface, \
        .access_rights = GB_AUDIO_ACCESS_##xaccess, .dai_cport = xcport, \
        .stream_type = GB_AUDIO_STREAM_TYPE_##xstream, \
    }

#define WIDGET(xname, xid, xtype, xstate, xctlid) \
    {   .name = xname, .id = xid, .type = GB_AUDIO_WIDGET_TYPE_##xtype, \
        .state = GB_AUDIO_WIDGET_STATE_##xstate, .control_ids = xctlid, \
    }

#define BITCTL(x, xreg, xshift, xinv) \
    {   x.reg = xreg; x.reg2 = xreg; x.shift = xshift; x.shift2 = xshift; \
        x.inv = xinv; \
    }

#define BITSCTL(x, xreg, xshift, xshift2, xinv) \
    {   x.reg = xreg; x.reg2 = xreg; x.shift = xshift; x.shift2 = xshift2; \
        x.inv = xinv; \
    }

#define BITSCTL_R(x, xreg, xreg2, xshift, xshift2, xinv) \
    {   x.reg = xreg; x.reg2 = xreg2; x.shift = xshift; x.shift2 = xshift2; \
        x.inv = xinv; \
    }

#define TLVCTL(x, xreg, xshift, xshift2, xinv, xmax) \
    {   x.reg = xreg; x.reg2 = xreg; x.shift = xshift; x.shift2 = xshift2; \
        x.inv = xinv; x.max = xmax; \
    }

#define RANGCTL(x, xreg, xshift, xshift2, xinv, xmax, xmin) \
    {   x.reg = xreg; x.reg2 = xreg; x.shift = xshift; x.shift2 = xshift2; \
        x.inv = xinv; x.max = xmax; x.min = xmin; \
    }

#define ENUMCTL(x, xreg, xshift, xmax, xmask, xtexts) \
    {   x.reg = xreg; x.reg2 = xreg; x.shift = xshift; x.shift2 = xshift; \
        x.max = xmax; x.mask = xmask; x.texts = xtexts; \
    }

#define ENUMSCTL(x, xreg, xshift, xshift2, xmax, xmask, xtexts) \
    {   x.reg = xreg; x.reg2 = xreg; x.shift = xshift; x.shift2 = xshift2; \
        x.max = xmax; x.mask = xmask; x.texts = xtexts; \
    }
#endif /* _RT5647_H_ */
